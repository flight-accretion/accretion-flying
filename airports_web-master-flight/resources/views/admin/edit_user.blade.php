    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-danger">
          ...
          <form id="form-add-route" role="form" method="POST" action="{{ url('/user/edit') }}">
            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="form-group col-md-4">
                  <label>Phone</label>
									<input name="phone" class="form-control" value="{{ $user->contact_number }}" />
                  ...
                  <label for="city">City</label>
                   <select id="city" class="form-control select2" name="city">
                      @foreach($cities as $city_id => $city)
                        <option value="{{ $city_id }}" <?php if($user->city_id == $city_id ) {echo "selected";}?>>{{ $city }}</option>
                      @endforeach
                   </select>

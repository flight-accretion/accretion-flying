            ...
            <div class="box-body">
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <span class="error-font text-danger">{{ $errors->first('state') }}</span>
                </div>
                <div class="form-group col-md-6">
                  <label for="city">City Name</label>
                  <input type="hidden" name="city-id" value="{{ $city->id }}">
                  <input type="text" class="form-control" id="city" placeholder="Enter City name" name="city" value="{{ $city->name }}">

          ...
          <div class="box-body">
            <div class="row">
              <div class="form-group col-md-4">
                ...
                <select class="form-control select2" id="location_1" name="location_1" disabled>
              ...
              <div class="form-group col-md-4">
                ...
                <select class="form-control select2" id="location_2" name="location_2" disabled>
                  @foreach($airports as $id => $airport)
              ...
              <div class="form-group col-md-4">
                ...
                <select class="form-control select2" id="plane" name="plane" disabled>
            ...
            <div class="row">
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="time" placeholder="Enter time" name="time" value="{{ $route->time }}" disabled>
                <span class="error-font text-danger">{{ $errors->first('time')}}</span>
              </div>
              <!-- <div class="form-group col-md-4">
                <label for="distance">Distance (In NM)</label>
                <input type="text" class="form-control" id="distance" placeholder="Enter distance" name="distance" value="{{ $route->distance }}" disabled>

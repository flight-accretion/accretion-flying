            ...
            <div class="box-body">
              ...
              <div class="row form-group">
                <div class="col-md-3 col-md-offset-3">
                  ...
                  <input type="text" class="form-control" name="from-date" placeholder="dd-mm-yyyy" value="{{ date('d-m-Y', strtotime($setting->from_date))}}" tabindex="2" disabled>
									<span class="error-font text-danger">{{ $errors->first('from-date') }}</span>
								</div>  
                <div class="col-md-3">
                  <label for="description">To Date *</label>						
                  <input type="text" class="form-control" name="to-date" placeholder="dd-mm-yyyy" value="{{ date('d-m-Y', strtotime($setting->to_date))}}" tabindex="2" disabled>
              ...
              <div class="row form-group igst <?php if(old('type', $setting->setting_type) == "1") {echo "hide";}?>">
                ...
                <div class="col-md-3">		
                  <input type="text" class="form-control hide" id="igst-rate" name="igst-rate" value="{{ $setting-> igst }}" disabled>

...
<html lang="en-US">
  ...
  <section id="contact">
    <div class="container">
			...
			Your booking was successful.</p><br/>
      <div class="row">
        <div class="col-lg-12 text-center">
				<?php $booking = $data['booking']; ?>
          <h2 class="section-heading">{{ $booking->plane_name }}</h2>
          <hr>
        </div>
      </div>
			<div class="row">
				<table border="1" style="border-collapse: collapse;" class="table table-hover table-bordered">
					<thead>
						<tr>
					...
					<tbody>
						...
						@if(isset($flights['base']))
							...
							<tr>
								<td>{{ date('d M, Y H:i', strtotime($flights['base']['departure_time'])) }}</td>
								...
								<td>{{ date('d M, Y H:i', strtotime($flights['base']['arrival_time'])) }}</td>
						...
						@if(isset($flights['arr']))
							...
							<tr>
								<td>{{ date('d M, Y H:i', strtotime($flights['arr']['departure_time'])) }}</td>
								...
								<td>{{ date('d M, Y H:i', strtotime($flights['arr']['arrival_time'])) }}</td>
			...
			<div class="row">
				<div class="col-md-6 col-md-offset-3">
					<table style="border-collapse: collapse;" border="1" class="table table-bordered">
						<thead>
							<tr>
								<th>Cost Details</th>

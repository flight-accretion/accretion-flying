    ...
    <div class="header-content">
      <div class="header-content-inner">
        <form id="search-planes" role="form" method="GET" action="<?php echo e(url('/plane/search')); ?>">
          ...
          <input id="old-departure" type="hidden" name="old-departure" value="<?php echo e($departure); ?>" />
          <input id="old-arrival" type="hidden" name="old-arrival" value="<?php echo e($arrival); ?>" />
          <input id="old-dep-latitude" type="hidden" name="old-dep-latitude" value="<?php echo e($dep_latitude); ?>" />
          <input id="old-dep-longitude" type="hidden" name="old-dep-longitude" value="<?php echo e($dep_longitude); ?>" />
          <input id="old-arr-latitude" type="hidden" name="old-arr-latitude" value="<?php echo e($arr_latitude); ?>" />
          <input id="old-arr-longitude" type="hidden" name="old-arr-longitude" value="<?php echo e($arr_longitude); ?>" />
          <input id="old-helicopter-departure" type="hidden" name="old-helicopter-departure" value="<?php echo e($helicopter_departure); ?>" />
          <input id="old-helicopter-arrival" type="hidden" name="old-helicopter-arrival" value="<?php echo e($helicopter_arrival); ?>" />
          <input id="old-plane-type" type="hidden" name="old-plane-type" value="<?php echo e($plane_type); ?>" />
          <input id="old-trip-type" type="hidden" name="old-trip-type" value="<?php echo e($trip_type); ?>" />
          <input id="old-adults" type="hidden" name="old-adults" value="<?php echo e($adults); ?>" />
          <input id="old-date" type="hidden" name="old-date" value="<?php echo e($date); ?>" />
          <input id="old-total-adults" type="hidden" name="old-total-adults" value="<?php echo e($total_adults); ?>" />
          <input id="gt1" type="hidden" name="gt1" value="<?php echo e($gt1); ?>" />
          <input id="gt2" type="hidden" name="gt2" value="<?php echo e($gt2); ?>" />
          <div class="row">
              ...
              <div class="form-group">
                <select class="form-control search-planes-element select2" id="planes" name="planes">
                  ...
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					...
					<div class="<?php if($trip_type == 2): ?> hide <?php endif; ?>"  id="non-multi-trip-div">
						<div class="row">
							<div class="col-md-2 col-md-offset-1 no-padding">
									...
									<select class="form-control search-planes-element select2" id="departure" name="departure">
										...
										<?php $__currentLoopData = $airports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $airport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<?php if($airport->id == $departure): ?>
												<option value="<?php echo e($airport->id); ?>" data-id="<?php echo e($airport->id); ?>" data-lat="<?php echo e($airport->latitude); ?>"  data-long="<?php echo e($airport->longitude); ?>"selected><?php echo e($airport->name); ?><?php if(isset($cities[$airport->city_id])): ?>,  <?php echo e($cities[$airport->city_id]->name); ?> <?php endif; ?></option>
											<?php else: ?>
												<option value="<?php echo e($airport->id); ?>" data-id="<?php echo e($airport->id); ?>" data-lat="<?php echo e($airport->latitude); ?>"  data-long="<?php echo e($airport->longitude); ?>" ><?php echo e($airport->name); ?><?php if(isset($cities[$airport->city_id])): ?>,  <?php echo e($cities[$airport->city_id]->name); ?> <?php endif; ?></option>
											<?php endif; ?>                   
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>
									<span class="text-danger"><?php echo e($errors->first('departure')); ?></span>
								</div>
								<div id="helicopter-dep-div" class="form-group hide">
									<input type="hidden" id="dep-latitude" name="dep-latitude"  value="<?php echo e($dep_latitude); ?>">
									<input type="hidden" id="dep-longitude" name="dep-longitude"  value="<?php echo e($dep_longitude); ?>">
									<input type="hidden" id="dep-helicopter" name="helicopter-departure" value="<?php echo e($helicopter_departure); ?>">
									<span class="text-danger"><?php echo e($errors->first('helicopter-departure')); ?></span>
								</div>
							</div>
							<div class="col-md-2 no-padding">
									...
									<select class="form-control search-planes-element select2" id="plane-air-arrival" name="arrival">
										...
										<?php $__currentLoopData = $airports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $airport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<?php if($airport->id == $arrival): ?>
												<option value="<?php echo e($airport->id); ?>" data-arr-id="<?php echo e($airport->id); ?>" data-arr-lat="<?php echo e($airport->latitude); ?>" data-arr-long="<?php echo e($airport->longitude); ?>" selected><?php echo e($airport->name); ?><?php if(isset($cities[$airport->city_id])): ?>,  <?php echo e($cities[$airport->city_id]->name); ?> <?php endif; ?></option>
											<?php else: ?>
												<option value="<?php echo e($airport->id); ?>" data-arr-id="<?php echo e($airport->id); ?>" data-arr-lat="<?php echo e($airport->latitude); ?>" data-arr-long="<?php echo e($airport->longitude); ?>"><?php echo e($airport->name); ?><?php if(isset($cities[$airport->city_id])): ?>, <?php echo e($cities[$airport->city_id]->name); ?> <?php endif; ?></option>
											<?php endif; ?> 
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>
									<span class="text-danger"><?php echo e($errors->first('arrival')); ?></span>
								</div>
								<div id="helicopter-arr-div" class="form-group hide">
									<input type="hidden" id="arr-latitude" name="arr-latitude"  value="<?php echo e($arr_latitude); ?>">
									<input type="hidden" id="arr-longitude" name="arr-longitude"  value="<?php echo e($arr_longitude); ?>">
									<input type="hidden" id="arr-helicopter" name="helicopter-arrival" value="<?php echo e($helicopter_arrival); ?>">
									<span class="text-danger"><?php echo e($errors->first('helicopter-arrival')); ?></span>
								</div>
							</div>
							<div class="col-md-2 no-padding">
								<div class="form-group">
						...
						<div class="row <?php if($trip_type != 1): ?> hide <?php endif; ?>" id="round-trip">
							<div class="col-md-2 col-md-offset-1 no-padding">
								<div id="plane-air-dep-round-div" class="form-group">
									<select class="form-control search-planes-element select2" id="plane-air-departure-round" name="round-departure">
										...
										<option value="" selected>Departure</option>
										<?php $__currentLoopData = $airports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $airport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<option value="<?php echo e($airport->id); ?>" data-lat-round="<?php echo e($airport->latitude); ?>" data-long-round="<?php echo e($airport->longitude); ?>"><?php echo e($airport->name); ?><?php if(isset($cities[$airport->city_id])): ?>, <?php echo e($cities[$airport->city_id]->name); ?> <?php endif; ?></option>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>
									<input type="hidden" id="dep-latitude-round" name="dep-latitude-round" value="<?php echo e($arr_latitude); ?>">
									<input type="hidden" id="dep-longitude-round" name="dep-longitude-round" value="<?php echo e($arr_longitude); ?>">
									<span class="error-font text-danger"><?php echo e($errors->first('round-departure')); ?></span>
								</div>
								<div id="helicopter-dep-round-div" class="form-group hide">
									<input type="hidden" id="helicopter-dep-round" name="round-helocopter-departure" value="<?php echo e($helicopter_arrival ?: 'Select From Map'); ?>">
									<span class="error-font text-danger"><?php echo e($errors->first('round-helocopter-departure')); ?></span>
								</div>
							</div>
							<div class="col-md-2 no-padding">
								<div id="plane-air-arr-round-div" class="form-group">
									<select class="form-control search-planes-element select2" id="plane-air-arrival-round" name="round-arrival">
										...
										<option value="" selected>Arrival</option>
										<?php $__currentLoopData = $airports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $airport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<option value="<?php echo e($airport->id); ?>" data-lat-arr-round="<?php echo e($airport->latitude); ?>" data-long-arr-round="<?php echo e($airport->longitude); ?>"><?php echo e($airport->name); ?><?php if(isset($cities[$airport->city_id])): ?>, <?php echo e($cities[$airport->city_id]->name); ?> <?php endif; ?></option>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>
									<span class="error-font text-danger"><?php echo e($errors->first('round-arrival')); ?></span>
								</div>
								<div id="helicopter-arr-round-div" class="form-group hide">
									<input type="hidden" id="helicopter-arr-round" name="round-helocopter-arrival" value="<?php echo e($helicopter_departure ?: 'Select From Map'); ?>">
									<span class="error-font text-danger"><?php echo e($errors->first('round-helocopter-arrival')); ?></span>
								</div>
							</div>
							<div class="col-md-2 no-padding">
								<div class="form-group">
									<input type="number" class="form-control search-planes-element" id="round-adults" placeholder="Adults" name="round-adults" value="<?php echo e($round_adults); ?>" min=1 oninput="validity.valid||(value='');">
									<span class="error-font text-danger"><?php echo e($errors->first('round-adults')); ?></span>
								</div>
							</div>
							<div class="col-md-2 no-padding">
								<div class="input-group date">								
									<input type="text" class="form-control date-picker search-planes-element" id="round-date" name="round-date" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"  value="<?php echo e($round_date); ?>" tabindex="2">
									
								</div>
								<span class="error-font text-danger"><?php echo e($errors->first('round-date')); ?></span>
							</div>
          ...
          <div class="<?php if($trip_type != 2): ?> hide <?php endif; ?>" id="multi-trip-div">
						<div class="multi-trip-div-row">
							<?php if($dep_multi_latitude == ''): ?>
								<div class="row multi-row-0">
									<div class="col-md-2 col-md-offset-1 no-padding">
										<div id="plane-dep-multi" class="plane-dep-multi form-group">
											<select class="form-control search-planes-element plane-air-departure-multi select2" data-index="0" id="plane-air-departure-multi-0" name="multi-departure[0]">
												...
												<option value="" selected>Departure</option>
												<?php $__currentLoopData = $airports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $airport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<option value="<?php echo e($airport->id); ?>" data-id="<?php echo e($airport->id); ?>" data-lat="<?php echo e($airport->latitude); ?>" data-long="<?php echo e($airport->longitude); ?>"><?php echo e($airport->name); ?><?php if(isset($cities[$airport->city_id])): ?>,  <?php echo e($cities[$airport->city_id]); ?> <?php endif; ?></option>
												<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
											</select>
											<span class="error-font text-danger"><?php echo e($errors->first('multi-departure.0') ?: $errors->first('multi-departure')); ?></span>
										</div>
										<div id="helicopter-dep-multi" data-type="1" data-index="0" class="helicopter-dep-multi form-group hide">
											...
											<span class="error-font text-danger"><?php echo e($errors->first('helicopter-multi-departure.0')); ?></span>
										</div>
									</div>
									<div class="col-md-2 no-padding">
										<div id="plane-arr-multi" class="plane-arr-multi form-group">
											<select class="form-control search-planes-element select2 plane-air-arrival-multi" data-index="0" id="plane-air-arrival-multi-0" name="multi-arrival[0]">
												...
												<option value="" selected>Arrival</option>
												<?php $__currentLoopData = $airports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $airport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<option value="<?php echo e($airport->id); ?>" data-arr-id="<?php echo e($airport->id); ?>" data-arr-lat="<?php echo e($airport->latitude); ?>" data-arr-long="<?php echo e($airport->longitude); ?>" ><?php echo e($airport->name); ?><?php if(isset($cities[$airport->city_id])): ?>,  <?php echo e($cities[$airport->city_id]); ?> <?php endif; ?></option>
												<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
											</select>
											<span class="error-font text-danger"><?php echo e($errors->first('multi-arrival.0') ?: $errors->first('multi-arrival')); ?></span>
										</div>
										<div id="helicopter-arr-multi" data-type="2" data-index="0" class="helicopter-arr-multi form-group hide">
											...
											<span class="error-font text-danger"><?php echo e($errors->first('helicopter-multi-arrival.0')); ?></span>
										</div>
									</div>
									<div class="col-md-2 col-xs-12 no-padding">
										<div class="form-group">
											...
											<span class="error-font text-danger"><?php echo e($errors->first('multi-adults.0') ?: $errors->first('multi-adults')); ?></span>
										</div>
									</div>
									<div class="col-md-2 col-xs-12 no-padding">
										<div class="input-group date margin-auto " >								
											<input type="text" class="form-control date-time-picker search-planes-element" name="multi-date[0]" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY" value="<?php echo e(date('d-m-Y H:m')); ?>" tabindex="2">
											<!--span class="input-group-addon">
												<span class="glyphicon glyphicon-calendar"></span>
											</span-->
										</div>
										<span class="error-font text-danger"><?php echo e($errors->first('multi-date.0') ?: $errors->first('multi-date')); ?></span>
									</div>
							...
							<?php elseif(is_array($dep_multi_latitude)): ?>
								<?php $keys = array_keys($dep_multi_latitude); ?>
								<?php $__currentLoopData = $dep_multi_latitude; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $dep_m_latitude): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<div class="row multi-row-<?php echo e($index); ?>">
										<div class="col-md-2 col-md-offset-1 no-padding">
											<div id="plane-dep-multi" class="plane-dep-multi form-group">
												<select class="form-control search-planes-element plane-air-departure-multi select2" data-index="<?php echo e($index); ?>" id="plane-air-departure-multi-<?php echo e($index); ?>" name="multi-departure[<?php echo e($index); ?>]">
													<option value="0" class="map-select-option" data-map-option="1">Select from map</option>
													<option value="" selected>Departure</option>
													<?php $__currentLoopData = $airports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $airport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
														<option value="<?php echo e($airport->id); ?>" data-id="<?php echo e($airport->id); ?>" data-lat="<?php echo e($airport->latitude); ?>" data-long="<?php echo e($airport->longitude); ?>" <?php if(isset($multi_departure[$index]) && $multi_departure[$index] == $airport->id): ?> selected <?php endif; ?>><?php echo e($airport->name); ?><?php if(isset($cities[$airport->city_id])): ?>,  <?php echo e($cities[$airport->city_id]->name); ?> <?php endif; ?></option>
													<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
												</select>
												<span class="error-font text-danger"><?php echo e($errors->first('multi-departure.'.$index)); ?></span>
											</div>
											<div id="helicopter-dep-multi" data-type="1" data-index="<?php echo e($index); ?>" class="helicopter-dep-multi form-group hide">
												<input type="hidden" id="dep-latitude-<?php echo e($index); ?>" value="<?php echo e($dep_m_latitude); ?>" name="dep-multi-latitude[<?php echo e($index); ?>]">
												<input type="hidden" id="dep-longitude-<?php echo e($index); ?>" value="<?php if(isset($dep_multi_longitude[$index])): ?><?php echo e($dep_multi_longitude[$index]); ?><?php endif; ?>" name="dep-multi-longitude[<?php echo e($index); ?>]">
												<input type="hidden" id="dep-helicopter-multi-<?php echo e($index); ?>" value="<?php echo e(isset($helicopter_multi_departure[$index]) && $helicopter_multi_departure[$index] ? $helicopter_multi_departure[$index] : 'Select From Map'); ?>" name="helicopter-multi-departure[<?php echo e($index); ?>]">
												<span class="error-font text-danger"><?php echo e($errors->first('helicopter-multi-departure.'.$index)); ?></span>
											</div>
										</div>
										<div class="col-md-2 no-padding">
											<div id="plane-arr-multi" class="plane-arr-multi form-group">
												<select class="form-control search-planes-element select2 plane-air-arrival-multi" data-index="<?php echo e($index); ?>" id="plane-air-arrival-multi-<?php echo e($index); ?>" name="multi-arrival[<?php echo e($index); ?>]">
													<option value="0" class="map-select-option" data-map-option="1">Select from map</option>
													<option value="" selected>Arrival</option>
													<?php $__currentLoopData = $airports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $airport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
														<option value="<?php echo e($airport->id); ?>" data-arr-id="<?php echo e($airport->id); ?>" data-arr-lat="<?php echo e($airport->latitude); ?>" data-arr-long="<?php echo e($airport->longitude); ?>" <?php if(isset($multi_arrival[$index]) && $multi_arrival[$index] == $airport->id): ?> selected <?php endif; ?>><?php echo e($airport->name); ?><?php if(isset($cities[$airport->city_id])): ?>,  <?php echo e($cities[$airport->city_id]->name); ?> <?php endif; ?></option>
													<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
												</select>
												<span class="error-font text-danger"><?php echo e($errors->first('multi-arrival.'.$index)); ?></span>
											</div>
											<div id="helicopter-arr-multi" data-type="2" data-index="<?php echo e($index); ?>" class="helicopter-arr-multi form-group hide">
												<input type="hidden" id="arr-latitude-<?php echo e($index); ?>" value="<?php if(isset($arr_multi_latitude[$index])): ?><?php echo e($arr_multi_latitude[$index]); ?><?php endif; ?>" name="arr-multi-latitude[<?php echo e($index); ?>]">
												<input type="hidden" id="arr-longitude-<?php echo e($index); ?>" value="<?php if(isset($arr_multi_longitude[$index])): ?><?php echo e($arr_multi_longitude[$index]); ?><?php endif; ?>" name="arr-multi-longitude[<?php echo e($index); ?>]">
												<input type="hidden" value="<?php echo e(isset($helicopter_multi_arrival[$index]) && $helicopter_multi_arrival[$index] ? $helicopter_multi_arrival[$index] : 'Select From Map'); ?>" id="arr-helicopter-multi-<?php echo e($index); ?>" name="helicopter-multi-arrival[<?php echo e($index); ?>]">
												<span class="error-font text-danger"><?php echo e($errors->first('helicopter-multi-arrival.'.$index)); ?></span>
											</div>
										</div>
										<div class="col-md-2 col-xs-12 no-padding">
											<div class="form-group">
												<input type="number" class="form-control search-planes-element margin-auto" placeholder="Adults" name="multi-adults[<?php echo e($index); ?>]" value="<?php if(isset($multi_adults[$index])): ?><?php echo e($multi_adults[$index]); ?><?php endif; ?>" min=1 oninput="validity.valid||(value='');">
												<span class="error-font text-danger"><?php echo e($errors->first('multi-adults.'.$index)); ?></span>
											</div>
										</div>
										<div class="col-md-2 col-xs-12 no-padding">
											<div class="input-group date margin-auto " >								
												<input type="text" class="form-control date-time-picker search-planes-element" name="multi-date[<?php echo e($index); ?>]" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY" value="<?php if(isset($multi_date[$index])): ?><?php echo e($multi_date[$index]); ?><?php endif; ?>" tabindex="2">
												
											</div>
											<span class="error-font text-danger"><?php echo e($errors->first('multi-date.'.$index)); ?></span>
										</div>
										<div class="col-md-2 col-md-offset-0 col-xs-6 col-xs-offset-3 no-padding <?php if(!(end($keys) == $index)): ?>hide <?php endif; ?>">
											<button type="submit" class="btn btn-search-plane margin-auto">SEARCH</button>
										</div>
										<div class="col-md-1 col-md-offset-0 col-xs-6 col-xs-offset-3 no-padding">
											<div class="form-group"></div>
											<a class="btn btn-primary delete-trip" data-index="<?php echo e($index); ?>"><i class="fa fa-minus"></i></a>
										</div>
									</div>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							<?php endif; ?>
          ...
          <div class="form-group cst">
            ...
            <select class="form-control select2" id="plane-subtypes-filter" multiple>
				<?php $__currentLoopData = $plane_subtypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $plane_subtype): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($plane_subtype->id); ?>" data-id="<?php echo e($plane_subtype->id); ?>"><?php echo e($plane_subtype->sub_type); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
          </div>
        </div>
...
<script>
  $(function () {
		...
		var crew_handling_default = parseFloat(<?php echo json_encode(isset($crew_handling) ? $crew_handling : 25000); ?>);
		if(isNaN(crew_handling_default) || crew_handling_default < 0) {
			crew_handling_default = 25000;
		}
		...
		function getCrewHandlingForAirport(airportId) {
			var amount = parseFloat(crew_handlings[airportId]);
			return !isNaN(amount) && amount >= 0 ? amount : crew_handling_default;
		}
		...
		function getMapLocationText(searchSelector, lat, lng, fallbackText) {
			...
			if(searchText !== '' && searchText.toLowerCase() !== 'select from map') {
				return searchText;
			}
		...
		function initializeMapSelectionsFromHidden() {
			...
			if(depText !== '' && depText.toLowerCase() !== 'select from map') {
				syncSelect2MapText('#departure', depText, 'Departure');
				syncSelect2MapText('#plane-air-arrival-round', depText, 'Arrival');
			}

			if(arrText !== '' && arrText.toLowerCase() !== 'select from map') {
			...
			$('.plane-air-departure-multi').each(function() {
				...
				if(mapText !== '' && mapText.toLowerCase() !== 'select from map') {
		...
		$('#add-more').click(function(){
			...
			multi_html += '				<?php $__currentLoopData = $airports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $airport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>';
			multi_html += '					<option value="<?php echo e($airport->id); ?>" data-id="<?php echo e($airport->id); ?>" data-lat="<?php echo e($airport->latitude); ?>" data-long="<?php echo e($airport->longitude); ?>"><?php echo e($airport->name); ?><?php if(isset($cities[$airport->city_id])): ?>,  <?php echo e($cities[$airport->city_id]->name); ?> <?php endif; ?></option>';
			multi_html += '				<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>';
			multi_html += '			</select>';
			multi_html += '		</div>';
			...
			multi_html += '				<?php $__currentLoopData = $airports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $airport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>';
			multi_html += '					<option value="<?php echo e($airport->id); ?>" data-arr-id="<?php echo e($airport->id); ?>" data-arr-lat="<?php echo e($airport->latitude); ?>" data-arr-long="<?php echo e($airport->longitude); ?>"  ><?php echo e($airport->name); ?><?php if(isset($cities[$airport->city_id])): ?>,  <?php echo e($cities[$airport->city_id]->name); ?> <?php endif; ?></option>';
			multi_html += '				<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>';
			multi_html += '			</select>';
			multi_html += '		</div>';
    ...
    $('.btn').on('click', function(){
      ...
      $(this).addClass('selected');
		...
		$('#departure').on('select2:select', function(e) {
  ...
  $('#long-multi').trigger('change');
		...
		$("#btn-multi").click(function(e){
			...
			var searchbox = getMapLocationText('#search-location-multi', pick_lat, pick_long, 'Select From Map');
			if(field_type == 1){
		...
		$("#btn-pick").click(function(e){
			...
			var searchbox = getMapLocationText('#search-location', pick_lat, pick_long, 'Select From Map');
		...
		$("#btn-drop").click(function(e){
			...
			var searchbox = getMapLocationText('#search-location-drop', drop_lat, drop_long, 'Select From Map');
    ...
    $("#departure").on('change', function() {
      ...
      var latitude = selectedOption.data('lat');
      var longitude = selectedOption.data('long');
      var departureText = selectedOption.text().trim();
    ...
    $("#plane-air-arrival").on('change', function() {
			...
			var latitude = selectedOption.data('arr-lat');
			var longitude = selectedOption.data('arr-long');
			var arrivalText = selectedOption.text().trim();
      ...
      $.ajax({
        ...
        success: function(data, textStatus, jqXHR){      
          ...
          for(var i=0; i<plane_list.length; i++)
          {
            ...
            var medical_cost = parseFloat(plane_list[i].medical_cost);
            if(isNaN(medical_cost)){
              medical_cost = 0;
            }
            var tax = normalizeGstRate(plane_list[i].tax);
           ...
           /* var hours = parseInt(String(time).split('.')[0]);
            ...
            var crew_handling_charges = 0;
						if(trip_type == 1) {
							crew_handling_charges = getCrewHandlingForAirport(arrival) * crew_handling_additional_days;
						}
           ...
           // console.log("Sub_total" +sub_total);
            ...
            if(type_id == 3){
              var final_amount = sub_total + medical_cost;
            ...
            if(type_id == 3){
              list += '<h5><label class="fixed-width"><b>Fixed Medical Team Cost</b></label> : <i class="fa fa-rupee"></i>'+medical_cost.toFixed()+'</h5>';
            } else{
              list += '<h5><label class="fixed-width"><b>GST ('+gstRateLabel(tax)+'%)</b></label> : <i class="fa fa-rupee"></i>'+tax_amount.toFixed()+'</h5>';
            }
          ...
          for(var i=0; i<plane_list.length; i++)
          {
            ...
            if(avail_planes_city_id != departure_city_id)
            {
                    ...
                    total_days += end.diff(start, "days") + 1;
										...
										crew_handling_charges += (getCrewHandlingForAirport(arrival[previous_index]) * crew_handling_additional_days);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById("btn-pick").addEventListener("click", function () {
    ...
    const place = document.getElementById("search-location").value || (lat && lng ? lat + ", " + lng : "Select From Map");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function setupHeliDropMap() {
    ...
    mapDrop.on("click", function (event) {
      const pos = event.latlng;
      markerDrop.setLatLng(pos);
      updateDropLatLng(pos.lat, pos.lng);
      reverseGeocodeDrop(pos.lat, pos.lng);
    });
  ...
  document.getElementById("btn-drop").addEventListener("click", function () {
    ...
    const place = document.getElementById("search-location-drop").value || (lat && lng ? lat + ", " + lng : "Select From Map");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function setupMultiTripMap() {
    ...
    mapMulti.on("click", function (event) {
      const pos = event.latlng;
      markerMulti.setLatLng(pos);
      updateMultiModalFields(pos.lat, pos.lng, "");
      reverseGeocodeMulti(pos.lat, pos.lng);
    });
    ...
    function syncLeafletSelect2MapText(selector, text, fallbackText) {
      ...
      let $mapOption = $select.find('option[data-map-option="1"]').first();
      if ($mapOption.length) {
        $mapOption.text(displayText).prop('disabled', false).prop('hidden', false);
      } else {
        $select.prepend($('<option>', { value: 0, text: displayText, class: 'map-select-option' }).attr('data-map-option', '1'));
  ...
  const place = document.getElementById("search-location-multi").value || (lat && lng ? lat + ", " + lng : "Select From Map");
...
<?php echo $__env->make('layouts.plane_header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\accretion-flying\airports_web-master-flight\resources\views/plane_list.blade.php ENDPATH**/ ?>
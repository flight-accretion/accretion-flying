...
<html>
  <head>
    ...
    <noscript><link rel="stylesheet" href="<?php echo e(asset('/css/jquery.fileupload-noscript.css')); ?>"></noscript>
    <noscript><link rel="stylesheet" href="<?php echo e(asset('/css/jquery.fileupload-ui-noscript.css')); ?>"></noscript>
    <link rel="stylesheet" href="/font-awesome/css/font-awesome.min.css" type="text/css">
    <link href="<?php echo e(asset('/css/slick/slick.css')); ?>" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo e(asset('/css/slick/slick-theme.css')); ?>">
    ...
    <link href="<?php echo e(asset('/css/all-skins.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('/plugins/iCheck/all.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('/plugins/jvectormap/jquery-jvectormap-1.2.2.css')); ?>" rel="stylesheet">
    ...
    <link href="<?php echo e(asset('/css/flying_calculation_admin.css')); ?>" rel="stylesheet">
    ...
    <div class="wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview <?php if (isset($menu) && $menu == 'users') {echo "active";} ?>">
              ...
              <ul class="treeview-menu <?php if (isset($menu) && $menu == 'users') {echo "menu-open";} ?>">
                <li class="<?php if (isset($sub_menu) && $sub_menu == 'view_users') {echo "active";} ?>"><a href="<?php echo e(url('/user')); ?>"><i class="fa fa-table text-white"></i>View Users</a></li>
                <li class="<?php if (isset($sub_menu) && $sub_menu == 'add_user') {echo "active";} ?>"><a href="<?php echo e(url('/user/add')); ?>"><i class="fa fa-plus text-white"></i>Add User</a></li>
              </ul>
            </li>
            <!-- <li class="treeview <?php if (isset($menu) && $menu == 'mail_contents') {echo "active";} ?>">
              <a href="#">
                ...
                <ul class="treeview-menu <?php if (isset($menu) && $menu == 'mail_contents') {echo "menu-open";} ?>">
                  <li class="<?php if (isset($sub_menu) && $sub_menu == 'view_mail_contents') {echo "active";} ?>"><a href="<?php echo e(url('/mail-content')); ?>"><i class="fa fa-table text-white"></i>View Mail Contents</a></li>
                </ul>
            ...
            <!-- <li class="treeview <?php if (isset($menu) && $menu == 'bookings') {echo "active";} ?>">
              <a href="#">
                ...
                <ul class="treeview-menu <?php if (isset($menu) && $menu == 'bookings') {echo "menu-open";} ?>">
                  <li class="<?php if (isset($sub_menu) && $sub_menu == 'view_bookings') {echo "active";} ?>"><a href="<?php echo e(url('/booking')); ?>"><i class="fa fa-table text-white"></i>View Bookings</a></li>
                  <li class="<?php if (isset($sub_menu) && $sub_menu == 'view_booking_points') {echo "active";} ?>"><a href="<?php echo e(url('/booking/points')); ?>"><i class="fa fa-table text-white"></i>Booking Points</a></li>
                </ul>
                <i class="fa fa-angle-right pull-right"></i>
              </a>
            </li> -->
            <li class="treeview <?php if (isset($menu) && $menu == 'cities') {echo "active";} ?>">
              ...
              <ul class="treeview-menu <?php if (isset($menu) && $menu == 'cities') {echo "menu-open";} ?>">
                <li class="<?php if (isset($sub_menu) && $sub_menu == 'view_cities') {echo "active";} ?>"><a href="<?php echo e(url('/city')); ?>"><i class="fa fa-table text-white"></i>View Cities</a></li>
                <li class="<?php if (isset($sub_menu) && $sub_menu == 'add_city') {echo "active";} ?>"><a href="<?php echo e(url('/city/add')); ?>"><i class="fa fa-plus text-white"></i>Add City</a></li>
              </ul>
            </li>
            <li class="treeview <?php if (isset($menu) && $menu == 'airports') {echo "active";} ?>">
              ...
              <ul class="treeview-menu <?php if (isset($menu) && $menu == 'airports') {echo "menu-open";} ?>">
                <li class="<?php if (isset($sub_menu) && $sub_menu == 'view_airports') {echo "active";} ?>"><a href="<?php echo e(url('/airport')); ?>"><i class="fa fa-table text-white"></i>View Airports</a></li>
                <li class="<?php if (isset($sub_menu) && $sub_menu == 'add_airport') {echo "active";} ?>"><a href="<?php echo e(url('/airport/add')); ?>"><i class="fa fa-plus text-white"></i>Add Airport</a></li>
              </ul>
            </li>
            <li class="treeview <?php if (isset($menu) && $menu == 'planes') {echo "active";} ?>">
              ...
              <ul class="treeview-menu <?php if (isset($menu) && $menu == 'planes') {echo "menu-open";} ?>">
                <li class="<?php if (isset($sub_menu) && $sub_menu == 'view_planes') {echo "active";} ?>"><a href="<?php echo e(url('/plane')); ?>"><i class="fa fa-table text-white"></i>View Machines</a></li>
                <li class="<?php if (isset($sub_menu) && $sub_menu == 'add_plane') {echo "active";} ?>"><a href="<?php echo e(url('/plane/add')); ?>"><i class="fa fa-plus text-white"></i>Add Machine</a></li>
              </ul>
            </li>
            <li class="treeview <?php if (isset($menu) && $menu == 'planes_subtype') {echo "active";} ?>">
              ...
              <ul class="treeview-menu <?php if (isset($menu) && $menu == 'planes_subtype') {echo "menu-open";} ?>">
                <li class="<?php if (isset($sub_menu) && $sub_menu == 'view_planes_subtype') {echo "active";} ?>"><a href="<?php echo e(url('/subtype')); ?>"><i class="fa fa-table text-white"></i>View Sub-type</a></li>
                <li class="<?php if (isset($sub_menu) && $sub_menu == 'add_plane_subtype') {echo "active";} ?>"><a href="<?php echo e(url('/subtype/add')); ?>"><i class="fa fa-plus text-white"></i>Add Sub-type</a></li>
              </ul>
            </li>
            <li class="treeview <?php if (isset($menu) && $menu == 'handling_charge') {echo "active";} ?>">
              ...
              <ul class="treeview-menu <?php if (isset($menu) && $menu == 'handling_charge') {echo "menu-open";} ?>">
                <li class="<?php if (isset($sub_menu) && $sub_menu == 'view_handling_charge') {echo "active";} ?>"><a href="<?php echo e(url('/handling-charge')); ?>"><i class="fa fa-table text-white"></i>View Handling Charge</a></li>
              </ul>
            </li>
            <li class="treeview <?php if (isset($menu) && $menu == 'settings') {echo "active";} ?>">
              ...
              <ul class="treeview-menu <?php if (isset($menu) && $menu == 'settings') {echo "menu-open";} ?>">
                <li class="<?php if (isset($sub_menu) && $sub_menu == 'view_settings') {echo "active";} ?>"><a href="<?php echo e(url('/setting')); ?>"><i class="fa fa-table text-white"></i>View Settings</a></li>
                <li class="<?php if (isset($sub_menu) && $sub_menu == 'add_setting') {echo "active";} ?>"><a href="<?php echo e(url('/setting/add')); ?>"><i class="fa fa-plus text-white"></i>Add Setting</a></li>
              </ul>
            </li>
            <li class="treeview <?php if (isset($menu) && $menu == 'route') {echo "active";} ?>">
              ...
              <ul class="treeview-menu <?php if (isset($menu) && $menu == 'route') {echo "menu-open";} ?>">
                <li class="<?php if (isset($sub_menu) && $sub_menu == 'view_routes') {echo "active";} ?>"><a href="<?php echo e(url('/route')); ?>"><i class="fa fa-table text-white"></i>View Routes</a></li>
                <li class="<?php if (isset($sub_menu) && $sub_menu == 'add_route') {echo "active";} ?>"><a href="<?php echo e(url('/route/add')); ?>"><i class="fa fa-plus text-white"></i>Add Route</a></li>
              </ul>
            </li>
            <!-- <li>
      ...
      <div class="content-wrapper">
        <?php echo $__env->make('partials.flash_toasts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <script src="<?php echo e(asset('/js/vendor/jquery.ui.widget.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('/js/jquery.fileupload-process.js')); ?>"></script>
    <script src="<?php echo e(asset('/js/jquery.fileupload-image.js')); ?>"></script>
    <script src="<?php echo e(asset('/js/jquery.fileupload-validate.js')); ?>"></script>
    <script src="<?php echo e(asset('/js/flying_calculation_file_upload.js')); ?>"></script>
    <script src="<?php echo e(asset('/js/editor.js')); ?>"></script>
    <!-- Datarange Picker -->
    <script src="<?php echo e(asset('/js/moment.js')); ?>"></script>
    <script src="<?php echo e(asset('/js/graph_demo.js')); ?>"></script>
		<script src="<?php echo e(asset('/js/daterangepicker.js')); ?>"></script>
		
	</body>
</html>
<?php /**PATH C:\xampp\htdocs\accretion-flying\airports_web-master-flight\resources\views/layouts/admin_header.blade.php ENDPATH**/ ?>
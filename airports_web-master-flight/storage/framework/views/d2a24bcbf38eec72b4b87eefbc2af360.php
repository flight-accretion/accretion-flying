    ...
    <div class="header-content">
      <div class="header-content-inner">
        <form id="search-planes" role="form" method="GET" action="<?php echo e(url('/plane/search')); ?>">
            ...
            <div class="col-md-2 col-md-offset-1 no-padding">
              <div class="form-group">
                <select class="form-control search-planes-element select2" id="trips" name="trips">
                  <option value="0" <?php if(old('trips') == 0): ?> selected <?php endif; ?>>Single Trip</option>
                  <option value="1" <?php if(old('trips') == 1): ?> selected <?php endif; ?>>Round Trip</option>
                  <option value="2" <?php if(old('trips') == 2): ?> selected <?php endif; ?>>Multi Trip</option>
                </select>          
                <span class="text-danger"><?php echo e($errors->first('trips')); ?></span>
              </div>
            </div>
            <div class="col-md-2 no-padding">
              <div class="form-group">
                <select class="form-control search-planes-element select2" id="planes" name="planes">
                  ...
                  <?php $__currentLoopData = $plane_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plane_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($plane_type->id); ?>" data-id="<?php echo e($plane_type->id); ?>"  <?php if(old('planes') == $plane_type->id): ?> selected <?php endif; ?>><?php echo e($plane_type->name); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  <option value="flower-shower" data-id="flower-shower" data-flower-shower="1">Flower Shower</option>
                </select>
                <span class="text-danger"><?php echo e($errors->first('planes')); ?></span>
              </div>
            </div>
          </div>
					<div class="<?php if(old('trips') == 2): ?> hide <?php endif; ?>"  id="non-multi-trip-div">
						<div class="row">
							<div class="col-md-2 col-md-offset-1 no-padding">
								<div id="plane-air-dep-div" class="form-group">
									<select class="form-control search-planes-element select2" id="plane-air-departure" name="departure">
										...
										<?php $__currentLoopData = $airports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $airport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<option value="<?php echo e($airport->id); ?>" data-id="<?php echo e($airport->id); ?>" data-lat="<?php echo e($airport->latitude); ?>" data-long="<?php echo e($airport->longitude); ?>" <?php if(old('departure') == $airport->id): ?> selected <?php endif; ?>><?php echo e($airport->name); ?><?php if(isset($cities[$airport->city_id])): ?>,  <?php echo e($cities[$airport->city_id]); ?> <?php endif; ?></option>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>
									<span class="text-danger"><?php echo e($errors->first('departure')); ?></span>
								</div>
								<div id="helicopter-dep-div" class="form-group hide">
									<input type="hidden" id="dep-latitude" name="dep-latitude"  value="<?php echo e(old('dep-latitude')); ?>">
									<input type="hidden" id="dep-longitude" name="dep-longitude"  value="<?php echo e(old('dep-longitude')); ?>">
									<input type="hidden" id="dep-helicopter" name="helicopter-departure" value="<?php echo e(old('helicopter-departure')); ?>">
							...
							<div class="col-md-2 no-padding">
								<div id="plane-air-arr-div" class="form-group">
									<select class="form-control search-planes-element select2" id="plane-air-arrival" name="arrival">
										...
										<?php $__currentLoopData = $airports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $airport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<option value="<?php echo e($airport->id); ?>" data-arr-id="<?php echo e($airport->id); ?>" data-arr-lat="<?php echo e($airport->latitude); ?>" data-arr-long="<?php echo e($airport->longitude); ?>"  <?php if(old('arrival') == $airport->id): ?> selected <?php endif; ?>><?php echo e($airport->name); ?><?php if(isset($cities[$airport->city_id])): ?>,  <?php echo e($cities[$airport->city_id]); ?> <?php endif; ?></option>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>
									<span class="text-danger"><?php echo e($errors->first('arrival')); ?></span>
								</div>
								<div id="helicopter-arr-div" class="form-group hide">
									<input type="hidden" id="arr-latitude" name="arr-latitude"  value="<?php echo e(old('arr-latitude')); ?>">
									<input type="hidden" id="arr-longitude" name="arr-longitude"  value="<?php echo e(old('arr-longitude')); ?>">
									<input type="hidden" id="arr-helicopter" name="helicopter-arrival" value="<?php echo e(old('helicopter-arrival')); ?>">
									<span class="text-danger"><?php echo e($errors->first('helicopter-arrival')); ?></span>
								</div>
							</div>
							<div class="col-md-2 col-xs-12 no-padding">
								<div class="form-group">
									<input type="number" class="form-control search-planes-element margin-auto" id="adults" placeholder="Adults" name="adults" value="<?php echo e(old('adults')); ?>" min=1 oninput="validity.valid||(value='');">
									<span class="error-font text-danger"><?php echo e($errors->first('adults')); ?></span>
								</div>
							</div>
							<div class="col-md-2 col-xs-12 no-padding">
								<div class="input-group date margin-auto " id="from-date">								
									<input type="text" class="form-control date-time-picker search-planes-element" id="date" name="date" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY" value="<?php echo e(date('d-m-Y H:m')); ?>" tabindex="2">
									
								</div>
								<span class="error-font text-danger"><?php echo e($errors->first('date')); ?></span>
							</div>
							<div class="col-md-2 col-md-offset-0 col-xs-6 col-xs-offset-3 no-padding <?php if(old('trips') == 1): ?> hide <?php endif; ?>" id="btn-search-single">
								<button type="submit" class="btn btn-search-plane margin-auto">SEARCH</button>
							</div>
						</div>
						<div class="row <?php if(old('trips') != 1): ?> hide <?php endif; ?>" id="round-trip">
							<div class="col-md-2 col-md-offset-1 no-padding">
								<div id="plane-air-dep-round-div" class="form-group">
									<select class="form-control search-planes-element select2" id="plane-air-departure-round" name="round-departure" readonly>
										...
										<option value="" selected>Departure</option>
										<?php $__currentLoopData = $airports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $airport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<option value="<?php echo e($airport->id); ?>" data-lat-round="<?php echo e($airport->latitude); ?>" data-long-round="<?php echo e($airport->longitude); ?>" <?php if(old('departure') == $airport->id): ?> selected <?php endif; ?>><?php echo e($airport->name); ?><?php if(isset($cities[$airport->city_id])): ?>,  <?php echo e($cities[$airport->city_id]); ?> <?php endif; ?></option>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>
									<input type="hidden" id="dep-latitude-round" name="dep-latitude-round"  value="<?php echo e(old('dep-latitude-round')); ?>">
									<input type="hidden" id="dep-longitude-round" name="dep-longitude-round"  value="<?php echo e(old('dep-longitude-round')); ?>">
								...
								<div id="helicopter-dep-round-div" class="form-group hide">
									<input type="hidden" id="helicopter-dep-round" name="round-helocopter-departure" value="<?php echo e(old('round-helocopter-departure') ?: 'Select From Map'); ?>">
							...
							<div class="col-md-2 no-padding">
								<div id="plane-air-arr-round-div" class="form-group">
									<select class="form-control search-planes-element select2" id="plane-air-arrival-round" name="round-arrival" readonly>
										...
										<option value="" selected>Arrival</option>
										<?php $__currentLoopData = $airports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $airport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<option value="<?php echo e($airport->id); ?>" data-lat-arr-round="<?php echo e($airport->latitude); ?>" data-long-arr-round="<?php echo e($airport->longitude); ?>" <?php if(old('departure') == $airport->id): ?> selected <?php endif; ?>><?php echo e($airport->name); ?><?php if(isset($cities[$airport->city_id])): ?>,  <?php echo e($cities[$airport->city_id]); ?> <?php endif; ?></option>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>
								...
								<div id="helicopter-arr-round-div" class="form-group hide">
									<input type="hidden" id="helicopter-arr-round" name="round-helocopter-arrival" value="<?php echo e(old('round-helocopter-arrival') ?: 'Select From Map'); ?>">
							...
							<div class="col-md-2 no-padding">
								<div class="input-group date">								
									<input type="text" class="form-control date-picker search-planes-element" id="round-date" name="round-date" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"  value="<?php echo e(date('d-m-Y H:m')); ?>" tabindex="2">
          ...
          <div class="<?php if(old('trips') != 2): ?> hide <?php endif; ?>" id="multi-trip-div">
...
<div id="flower-shower-modal" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form id="search-planes" method="GET" action="<?php echo e(url('/plane/search')); ?>">
        ...
        if(!validateSearchForm($(this))) {
          ...
          return false;
			...
			$('#add-more').click(function(){
				...
				multi_html += '					<option value="<?php echo e($airport->id); ?>" data-id="<?php echo e($airport->id); ?>" data-lat="<?php echo e($airport->latitude); ?>" data-long="<?php echo e($airport->longitude); ?>"><?php echo e($airport->name); ?><?php if(isset($cities[$airport->city_id])): ?>,  <?php echo e($cities[$airport->city_id]); ?> <?php endif; ?></option>';
				...
				multi_html += '				<?php $__currentLoopData = $airports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $airport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>';
				multi_html += '					<option value="<?php echo e($airport->id); ?>" data-arr-id="<?php echo e($airport->id); ?>" data-arr-lat="<?php echo e($airport->latitude); ?>" data-arr-long="<?php echo e($airport->longitude); ?>"  ><?php echo e($airport->name); ?><?php if(isset($cities[$airport->city_id])): ?>,  <?php echo e($cities[$airport->city_id]); ?> <?php endif; ?></option>';
				multi_html += '				<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>';
				multi_html += '			</select>';
				multi_html += '		</div>';
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const locationIqKey = <?php echo json_encode(env('LOCATIONIQ_API_KEY', ''), 512) ?>;
  const mapState = {};
...
<?php echo $__env->make('layouts.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\accretion-flying\airports_web-master-flight\resources\views/home.blade.php ENDPATH**/ ?>